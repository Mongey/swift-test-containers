...
- `Sources/TestContainers/`: core API (`ContainerRequest`, `Container`, `DockerClient`, wait/probe helpers, service-specific containers).
...
Docker CLI must be installed and available on `PATH` for runtime and integration tests.
